      ...
      <div className="w-full max-w-md">
        ...
        <div className="grid gap-4">
          <form action={chooseOnboardingRole}>
            ...
            <button
              type="submit"
              className="w-full rounded-xl border-2 border-[#E8623A] bg-[#FFF8F2] p-5 text-left transition hover:bg-[#FDE8DF] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#E8623A]"
            >
          ...
          <form action={chooseOnboardingRole}>
            ...
            <button
              type="submit"
              className="w-full rounded-xl border-2 border-[#E8DDD4] bg-[#FFF8F2] p-5 text-left transition hover:border-[#E8623A] hover:bg-[#FDE8DF] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#E8623A]"
            >
              <div className="flex items-start gap-4">
